...
.NET SDK 10.0.100
  [Host]     : .NET 10.0.0 (10.0.0), X64 RyuJIT AVX2
  Job-AYCPZN : .NET 10.0.0 (10.0.0), X64 RyuJIT AVX2
...
|----------------------------------- |------------------- |------------- |----------:|----------:|----------:|------:|--------:|--------:|-------:|----------:|------------:|
| SqlBuilder (Dapper)                | .NET 10.0           | Simple query |  1.614 us | 0.0274 us | 0.0229 us |  1.00 |    0.00 |  0.6371 | 0.0038 |   2.93 KB |        1.00 |
| Builder                            | .NET 10.0           | Simple query |  1.222 us | 0.0164 us | 0.0145 us |  0.76 |    0.02 |  0.9785 | 0.0114 |    4.5 KB |        1.54 |
| FluentBuilder                      | .NET 10.0           | Simple query |  1.390 us | 0.0185 us | 0.0164 us |  0.86 |    0.02 |  0.9975 | 0.0134 |   4.59 KB |        1.57 |
| Builder (Reuse parameters)         | .NET 10.0           | Simple query |  1.842 us | 0.0193 us | 0.0171 us |  1.14 |    0.01 |  1.0376 | 0.0153 |   4.77 KB |        1.63 |
| FluentBuilder (Reuse parameters)   | .NET 10.0           | Simple query |  1.987 us | 0.0386 us | 0.0361 us |  1.23 |    0.03 |  1.0567 | 0.0153 |   4.86 KB |        1.66 |
|                                    |                    |              |           |           |           |       |         |         |        |           |             |
...
|                                    |                    |              |           |           |           |       |         |         |        |           |             |
|                                    |                    |              |           |           |           |       |         |         |        |           |             |
| SqlBuilder (Dapper)                | .NET 10.0           | Large query  | 27.432 μs | 0.1997 μs | 0.1868 μs |  1.00 |    0.00 |  9.2163 | 0.7629 |  42.42 KB |        1.00 |
| Builder                            | .NET 10.0           | Large query  | 16.493 μs | 0.2553 μs | 0.2264 μs |  0.60 |    0.01 | 10.6506 | 1.1597 |  49.05 KB |        1.16 |
| FluentBuilder                      | .NET 10.0           | Large query  | 18.964 μs | 0.2916 μs | 0.2728 μs |  0.69 |    0.01 | 10.6201 | 1.3123 |  48.89 KB |        1.15 |
| Builder (Reuse parameters)         | .NET 10.0           | Large query  | 12.842 μs | 0.1155 μs | 0.0902 μs |  0.47 |    0.01 |  6.3934 | 0.2594 |  29.41 KB |        0.69 |
| FluentBuilder (Reuse parameters)   | .NET 10.0           | Large query  | 14.713 μs | 0.1177 μs | 0.1044 μs |  0.54 |    0.01 |  6.3629 | 0.2441 |   29.3 KB |        0.69 |
|                                    |                    |              |           |           |           |       |         |         |        |           |             |
