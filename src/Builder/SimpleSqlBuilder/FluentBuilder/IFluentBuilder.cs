...
/// </summary>
public interface IFluentBuilder : ISqlBuilder
{
    /// <summary>
    ...
    /// <returns>Returns <see cref="IFluentBuilder"/>.</returns>
    IFluentBuilder AddParameter(string name, object? value = null, DbType? dbType = null, ParameterDirection? direction = null, int? size = null, byte? precision = null, byte? scale = null);
