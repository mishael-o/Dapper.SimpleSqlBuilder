...
public ref struct AppendNewLineInterpolatedStringHandler
{
    ...
    public AppendNewLineInterpolatedStringHandler(int literalLength, int formattedCount, Builder builder)
    {
