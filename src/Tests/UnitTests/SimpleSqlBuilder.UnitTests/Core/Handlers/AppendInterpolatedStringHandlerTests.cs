...
public class AppendInterpolatedStringHandlerTests
{
    [Fact]
    ...
    public void Constructor_InitialisesHandler_ReturnsHandler()
    {
        ...
        // Act
        _ = new AppendInterpolatedStringHandler(0, 0, builder, out var _);

        // Assert
        builderFormatterMock.Received().AppendControl(ControlType.Space);
    }
    ...
    public void Constructor_HandlerDisabledByCondition_ReturnsHandler()
    {
        ...
        // Act
        _ = new AppendInterpolatedStringHandler(0, 0, condition, builder, out var isHandlerEnabled);
    ...
    public void AppendLiteral_AppendsLiteral_ReturnsVoid(string value)
    {
        // Arrange
        var builder = Dapper.SimpleSqlBuilder.UnitTests.UnitTestSubstitutes.CreateBuilder(out var builderFormatterMock);
        var sut = new AppendInterpolatedStringHandler(0, 0, builder, out var _);
