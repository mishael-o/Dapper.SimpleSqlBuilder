...
public class AppendIntactInterpolatedStringHandlerTests
{
    ...
    public void Constructor_HandlerDisabledByCondition_ReturnsHandler()
    {
        ...
        // Act
        _ = new AppendIntactInterpolatedStringHandler(0, 0, condition, builder, out var isHandlerEnabled);
    ...
    public void AppendLiteral_AppendsLiteral_ReturnsVoid(string value)
    {
        ...
        var sut = new AppendIntactInterpolatedStringHandler(0, 0, builder, out var _);
