...
public class AppendNewLineSqlIntepolatedStringHandlerTests
{
    [Fact]
    public void Constructor_BuilderIsNull_ThrowsArgumentException()
    {
        ...
        //Act
        Action act = () => _ = new AppendNewLineSqlIntepolatedStringHandler(0, 0, builder);
    ...
    {
        //Act
        Action act = () => _ = new AppendNewLineSqlIntepolatedStringHandler(0, 0, builderMock.Object);
    ...
    [Theory]
    [AutoData]
    public void Constructor_InitialisesHandler_ReturnsHandler(Mock<ISqlBuilder> builderMock)
    {
        //Arrange
        var builderFormatterMock = builderMock.As<IBuilderFormatter>();

        //Act
        var sut = new AppendNewLineSqlIntepolatedStringHandler(0, 0, builderMock.Object);
