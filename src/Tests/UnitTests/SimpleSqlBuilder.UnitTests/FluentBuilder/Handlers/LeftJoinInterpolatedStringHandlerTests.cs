...
public class LeftJoinInterpolatedStringHandlerTests
{
    ...
    public void Constructor_InitialisesHandler_ReturnsHandler()
    {
        ...
        // Act
        _ = new LeftJoinInterpolatedStringHandler(0, 0, fluentBuilder, out var isHandlerEnabled);

        // Assert
        isHandlerEnabled.ShouldBeTrue();
        fluentFormatterMock.Received().StartClauseAction(ClauseAction.LeftJoin);
    }
    ...
    public void Constructor_HandlerDisabledByCondition_ReturnsHandler()
    {
        ...
        // Act
        _ = new LeftJoinInterpolatedStringHandler(0, 0, condition, fluentBuilder, out var isHandlerEnabled);
    ...
    public void AppendLiteral_AppendsLiteral_ReturnsVoid(string value)
    {
        // Arrange
        var fluentBuilder = Dapper.SimpleSqlBuilder.UnitTests.UnitTestSubstitutes.CreateFluentBuilder(out var fluentFormatterMock);
        var sut = new LeftJoinInterpolatedStringHandler(0, 0, fluentBuilder, out var _);
