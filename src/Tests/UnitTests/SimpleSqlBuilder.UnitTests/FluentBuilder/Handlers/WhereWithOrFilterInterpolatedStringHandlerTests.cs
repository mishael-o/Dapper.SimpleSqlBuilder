...
public class WhereWithOrFilterInterpolatedStringHandlerTests
{
    ...
    public void Constructor_InitialiseHandler_HandlerInitialised(Mock<IFluentBuilder> fluentBuilderMock)
    {
        ...
        fluentSqlFormatterMock.Verify(x => x.StartClauseAction(ClauseAction.WhereWithOrFilter));
    }
    ...
    public void Constructor_InitialiseHandlerWithCondition_HandlerInitialised(Mock<IFluentBuilder> fluentBuilderMock)
    {
        ...
        //Act
        var sut = new WhereWithOrFilterInterpolatedStringHandler(0, 0, condition, fluentBuilderMock.Object, out var isHandlerEnabled);
    ...
    public void Close_ClauseActionEnded_ReturnsVoid(Mock<IFluentBuilder> fluentBuilderMock)
    {
        ...
        //Assert
        fluentSqlFormatterMock.Verify(x => x.EndClauseAction(ClauseAction.WhereWithOrFilter));
    }
}
#endif
