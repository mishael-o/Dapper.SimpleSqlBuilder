...
public class HavingInterpolatedStringHandlerTests
{
    ...
    public void Constructor_InitialisesHandler_ReturnsHandler()
    {
        ...
        fluentFormatterMock.IsClauseActionEnabled(ClauseAction.Having).Returns(true);

        // Act
        _ = new HavingInterpolatedStringHandler(0, 0, fluentBuilder, out var isHandlerEnabled);

        // Assert
        isHandlerEnabled.ShouldBeTrue();
        fluentFormatterMock.Received().StartClauseAction(ClauseAction.Having);
    }
    ...
    public void Constructor_HandlerDisabledByCondition_ReturnsHandler()
    {
        ...
        // Act
        _ = new HavingInterpolatedStringHandler(0, 0, condition, fluentBuilder, out var isHandlerEnabled);
    ...
    public void Constructor_HandlerDisabledByClauseAction_ReturnsHandler()
    {
        ...
        fluentFormatterMock.IsClauseActionEnabled(ClauseAction.Having).Returns(false);
    ...
    public void AppendLiteral_AppendsLiteral_ReturnsVoid(string value)
    {
        ...
        var sut = new HavingInterpolatedStringHandler(0, 0, fluentBuilder, out var _);
