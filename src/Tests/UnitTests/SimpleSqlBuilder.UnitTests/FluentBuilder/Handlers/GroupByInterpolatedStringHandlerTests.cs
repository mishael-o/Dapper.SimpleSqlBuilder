...
public class GroupByInterpolatedStringHandlerTests
{
    ...
    public void Constructor_InitialisesHandler_ReturnsHandler()
    {
        ...
        fluentFormatterMock.IsClauseActionEnabled(ClauseAction.GroupBy).Returns(true);

        // Act
        _ = new GroupByInterpolatedStringHandler(0, 0, fluentBuilder, out var isHandlerEnabled);

        // Assert
        isHandlerEnabled.ShouldBeTrue();
        fluentFormatterMock.Received().StartClauseAction(ClauseAction.GroupBy);
    }
    ...
    public void Constructor_HandlerDisabledByCondition_ReturnsHandler()
    {
        ...
        // Act
        _ = new GroupByInterpolatedStringHandler(0, 0, condition, fluentBuilder, out var isHandlerEnabled);
    ...
    public void Constructor_HandlerDisabledByClauseAction_ReturnsHandler()
    {
        ...
        fluentFormatterMock.IsClauseActionEnabled(ClauseAction.GroupBy).Returns(false);
    ...
    public void AppendLiteral_AppendsLiteral_ReturnsVoid(string value)
    {
        ...
        var sut = new GroupByInterpolatedStringHandler(0, 0, fluentBuilder, out var _);
