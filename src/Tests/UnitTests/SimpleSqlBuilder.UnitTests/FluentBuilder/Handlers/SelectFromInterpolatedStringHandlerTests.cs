...
public class SelectFromInterpolatedStringHandlerTests
{
    ...
    public void Constructor_InitialiseHandler_HandlerInitialised(Mock<IFluentBuilder> fluentBuilderMock)
    {
        ...
        //Act
        var sut = new SelectFromInterpolatedStringHandler(0, 0, fluentBuilderMock.Object);

        //Assert
        fluentSqlFormatterMock.Verify(x => x.StartClauseAction(ClauseAction.SelectFrom));
    }
    ...
    public void Close_ClauseActionEnded_ReturnsVoid(Mock<IFluentBuilder> fluentBuilderMock)
    {
        ...
        //Assert
        fluentSqlFormatterMock.Verify(x => x.EndClauseAction(ClauseAction.SelectFrom));
    }
}
#endif
